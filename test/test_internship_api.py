...
class TestInternshipApi(unittest.TestCase):
    ...
    def test_masters_allocations_specialty_organization_get(self):
        """Test case for masters_allocations_specialty_organization_get

        """
        pass

    def test_masters_allocations_specialty_organization_post(self):
        """Test case for masters_allocations_specialty_organization_post
    ...
    def test_scores_affectation_uuid_validate_get(self):
        """Test case for scores_affectation_uuid_validate_get

        """
        pass

    def test_scores_student_uuid_period_uuid_get(self):
        """Test case for scores_student_uuid_period_uuid_get

        """
        pass

    def test_scores_student_uuid_period_uuid_put(self):
        """Test case for scores_student_uuid_period_uuid_put
