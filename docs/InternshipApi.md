...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.place_evaluation_items_cohort_get(cohort, limit=limit, offset=offset, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->place_evaluation_items_cohort_get: %s\n" % e)
```
...
# **save_choice_internship_uuid_post**
> save_choice_internship_uuid_post(internship_uuid, internship_choice_create_command)
...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    ...
    internship_choice_create_command = InternshipChoiceCreateCommand(
        organization_uuid="organization_uuid_example",
        specialty_uuid="specialty_uuid_example",
        choice=1,
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.save_choice_internship_uuid_post(internship_uuid, internship_choice_create_command)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->save_choice_internship_uuid_post: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_instance.save_choice_internship_uuid_post(internship_uuid, internship_choice_create_command, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->save_choice_internship_uuid_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **internship_uuid** | **str**| The UUID of the internship |
 **internship_choice_create_command** | [**InternshipChoiceCreateCommand**](InternshipChoiceCreateCommand.md)|  |
 **accept_language** | **AcceptedLanguageEnum**| The header advertises which languages the client is able to understand, and which locale variant is preferred. (By languages, we mean natural languages, such as English, and not programming languages.)  | [optional]
 **x_user_first_name** | **str**|  | [optional]
 **x_user_last_name** | **str**|  | [optional]
 **x_user_email** | **str**|  | [optional]
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | Successful save internship choice |  -  |
**404** | Error saving internship choice |  -  |
...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.specialties_get(cohort_name=cohort_name, selectable=selectable, limit=limit, offset=offset, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
...
> StudentAffectationGet students_affectations_affectation_uuid_get(affectation_uuid)
...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internship_api.InternshipApi(api_client)
    affectation_uuid = "affectation_uuid_example" # str | The UUID of the student's affectation
    accept_language = AcceptedLanguageEnum("en") # AcceptedLanguageEnum | The header advertises which languages the client is able to understand, and which locale variant is preferred. (By languages, we mean natural languages, such as English, and not programming languages.)  (optional)
    x_user_first_name = "X-User-FirstName_example" # str |  (optional)
    x_user_last_name = "X-User-LastName_example" # str |  (optional)
    x_user_email = "X-User-Email_example" # str |  (optional)
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.students_affectations_affectation_uuid_get(affectation_uuid)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.students_affectations_affectation_uuid_get(affectation_uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->students_affectations_affectation_uuid_get: %s\n" % e)
```
...
> InlineResponse2001 students_affectations_specialty_organization_stats_get(organization, specialty)
...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    global_id = "global_id_example" # str | Filter by global id (optional)
    cohort_name = "cohort_name_example" # str | Filter by cohort (optional)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.students_get(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, global_id=global_id, cohort_name=cohort_name)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
...
# **students_global_id_get**
> StudentGet students_global_id_get(global_id)
...
with osis_internship_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internship_api.InternshipApi(api_client)
    global_id = "global_id_example" # str | The global_id of the internship student
    accept_language = AcceptedLanguageEnum("en") # AcceptedLanguageEnum | The header advertises which languages the client is able to understand, and which locale variant is preferred. (By languages, we mean natural languages, such as English, and not programming languages.)  (optional)
    x_user_first_name = "X-User-FirstName_example" # str |  (optional)
    x_user_last_name = "X-User-LastName_example" # str |  (optional)
    x_user_email = "X-User-Email_example" # str |  (optional)
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.students_global_id_get(global_id)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->students_global_id_get: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.students_global_id_get(global_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_internship_sdk.ApiException as e:
        print("Exception when calling InternshipApi->students_global_id_get: %s\n" % e)
```
