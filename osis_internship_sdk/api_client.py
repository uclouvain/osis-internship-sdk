...
from osis_internship_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from osis_internship_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.1.15/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.choices_get  # this is an instance of the class Endpoint
        api_instance.choices_get()  # this invokes api_instance.choices_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.choices_get.callable or self.callable in this class
